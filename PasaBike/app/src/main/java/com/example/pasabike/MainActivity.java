    ...
    private void requestOTP(String phonenumber) {
        PhoneAuthProvider.getInstance().verifyPhoneNumber(phonenumber, 60L, TimeUnit.SECONDS, this, new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(String s, PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                Toast.makeText(com.example.pasabike.MainActivity.this,"One Time Password Sent!", Toast.LENGTH_LONG).show();
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                Toast.makeText(com.example.pasabike.MainActivity.this,"Cannot Create an Account" + e.getMessage(), Toast.LENGTH_SHORT).show();
